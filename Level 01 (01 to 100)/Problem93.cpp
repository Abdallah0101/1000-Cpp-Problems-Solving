 ...
 * and counts the total number of even numbers in the array.
 */
...
int countEvenNumbers(const int arr[], int length) {
    int count = 0;
    for (int i = 0; i < length; i++) {
...
int main() {
    ...
    cout << "\nThe count of even numbers is: " << countEvenNumbers(arr, length) << endl;
